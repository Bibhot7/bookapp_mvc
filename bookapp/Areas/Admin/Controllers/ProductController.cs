   ...
   
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            //Passing the product in the view.
            return View(objProductList);


        }
        //Creating an action method for (Create new product method which will be invocked calling the view).
        ...
        {  //Deleting a product
            Product? obj = _unitOfWork.Product.Get(u => u.Id == id); if (obj == null)
            {
                return NotFound();
            }
